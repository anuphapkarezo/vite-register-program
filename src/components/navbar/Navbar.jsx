...
export default function Navbar({ onToggle }) {
  ...
  React.useEffect(() => {
    switch (location.pathname) {
      case "/register_user_master_nap":
        setMenuName("User Master NAP");
        setMenuIcon(<img src="/user-master-nap.png" alt="" width={30} />);
        break;
      case "/register_user_system_role":
      ...
      //   break;
      default:
        setMenuName("Register Authorization");
    ...
    <>
      <Box sx={{ display: "flex" }}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List open={open}>
            <ListItem
              onClick={() => setMenuName("User Master NAP")}
              disablePadding
              sx={{ display: "block", color: "black" }}
              component={Link}
              to="/register_user_master_nap"
            >
              <ListItemButton
                sx={{
                  minHeight: 48,
              ...
              >
                ...
                >
                  <img src="/user-master-nap.png" alt="" width={30} />
                  
                </ListItemIcon>
                <ListItemText
                  primary="User Master NAP"
                  sx={{ opacity: open ? 1 : 0 }}
                />
              </ListItemButton>
            </ListItem>
          ...
          {/* // Map user system role */}
          <List open={open}>
            <ListItem
              onClick={() => setMenuName("Map user system role")}
              disablePadding
              sx={{ display: "block", color: "black" }}
              component={Link}
              to="/register_user_system_role"
            >
              <ListItemButton
                sx={{
                  minHeight: 48,
              ...
              >
                ...
                >
                  <img src="/data-complexity.png" alt="" width={30} />
                </ListItemIcon>
                <ListItemText
                  primary="Map system"
                  sx={{ opacity: open ? 1 : 0 }}
